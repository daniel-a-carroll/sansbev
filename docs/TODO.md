...
2. **Get the organic certification records on file**
...
3. **Confirm the juice percentage in the finished formula**
...
4. **Have counsel review the 400mg L-theanine dose alongside the 220mg caffeine**
...
5. **Legal review of src/data/claims.ts, including the About page language**
...
6. **Export a real SVG wordmark to fulfil the logo-wordmark slot**
...
7. **Legal review of the privacy policy and terms**
...
8. **Write the founder biography and production location on the About page**
...
- **L222** — one sentence describing what is in the can. Composition only, no effect language.
- **L251** — juice percentage. Also the open question for the "healthy" claim.
- **L255** — sweetener approach, stated as composition
- **L261** — e.g. "No artificial colors"
- **L262** — e.g. "No artificial flavors"
- **L263** — carbohydrate/sugar statement, stated factually
